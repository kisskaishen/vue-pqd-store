...
<template>
 <div class="self_chat"  @keydown="KeyDown();">
	        ...
	        <ul class="contact" id="warpContact">
	            <li v-for="(userItem,index) in sessionList" @click="getUserInfo(userItem.sessionId,index,userItem.userName,userItem.headPic)">
	                ...
	                <div class="left_content">
	                    <div class="title">{{userItem.userName | decode}}<span class="times">{{new Date().formatChat(userItem.time)}}</span></div>
     ...
     <div class="center_chat">
         <div class="top">{{currentName | decode}}</div>
         <div class="content">
                        ...
                        <div class="char_content">
                            <div class="right_name" v-show="child.from==recevierUserId">
                                ...
                                <div class="chat_info" v-show="child.url">
                                    <img  @click="clickImg($event)" style="width:64px;height:64px" :src="child.url" alt="">
                            ...
                            <div class="left_name" v-show="child.from!=recevierUserId">
                                ...
                                <div class="chat_info" v-show="child.url">
                                    <img  @click="clickImg($event)" style="width:80px;height:80px" class="show_imgs" :src="child.url" alt="">
                                    <!--<img  @click="clickImg($event)" style="width:64px;height:64px" :src="child.url" alt="">-->
			                        <big-img v-if="showImg" @clickit="viewImg" :imgSrc="imgSrc"></big-img>
                                </div>
                                <div class="goodsLink" v-show="child.ext.goods">
         ...
         <div class="content">
            ...
            <div class="show_sec" v-show="latest_order">
                ...
                <div class="shop_order" v-show="orderCategoryStore">
                    <ul class="shop_order_status" @click="getOrderDetail(item)">
                    	<li v-for="(item,index) in storeData" :ids="item.value" :class="timeIndex == index ? 'status_class active' : 'status_class'">{{item.label}}</li>
                ...
                <div class="people_order" v-show="orderCategoryPeople">
                    <ul class="show_sec_status" @click="selectStatus()">
                        <li v-for="(item,index) in personalData" :ids="item.value" :class="timeIndex == index ? 'status_class active' : 'status_class'">{{item.label}}</li>
     ...
     <el-dialog
        ...
        <el-form ref="form" :model="form" label-width="80px">
            ...
            <el-form-item label="地址">
                ...
                <div class="width-120 margin-left-10" style="float:left">
                    <el-select v-model="form.district" placeholder="">
...
WebIM.config = {
  ...
  isSandBox: false,
  isDebug: false,
  autoReconnectNumMax: 30000000000,
...
//		status:'1'
//	}
//	webim.chatStatus('store/chatStatus', data,this);
...
//              	that.$route.meta.title = '您有新消息哦';
                    ...
                    webim.saveMsg(that,message);
                    webim.sessionListConduct(that,message);
//                webim.sessionListConduct(message);
//                webim.saveMsg(message)
              }, //收到图片消息
     ...
     created(){
     	setInterval(()=>{
     		...
     		this.setCookie("is_chat", str, 1)
     	},1000)
		webim.getStoreInfo('Chat/getStoreInfo',this);
		webim.chatInfo('Chat/getInfo', this);
		webim.orderChatStatus('order/orderChatStatus', this);
     },
   data () {
     return {
     	timeIndex:0,
   ...
   methods:{
       ...
       getOrderDetail(params){
           ...
           if(target.nodeName.toLowerCase() == "li"){
            ...
            target.className = "order_class active";
           }
       ...
       selectStatus(){
           ...
           if(target.nodeName.toLowerCase() == "li"){
            ...
            target.className = "status_class active";
           }
           var idStr = target.getAttribute("ids");
